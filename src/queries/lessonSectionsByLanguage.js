...
*/
const getAllLessonSectionsByLessonIdByLanguage = async (lesson_id, language_id) => {
  try {
    const allLessonSectionsByLessonIdByLanguage = await db.any("SELECT * FROM lesson_sections WHERE lesson_id=$1 ORDER BY id ASC;", [lesson_id, language_id]);
...
module.exports = {
  ...
  getAllLessonSectionsByLessonIdByLanguage,
